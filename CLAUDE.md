...
```
.devtmp/venv/bin/pio run -e elecrow_crowpanel_advance_35_companion_radio_lvgl            # build
.devtmp/venv/bin/pio run -e elecrow_crowpanel_advance_35_companion_radio_lvgl -t upload  # flash
```
